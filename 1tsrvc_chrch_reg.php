...
if (isset($_POST['submit'])) {
	...
	$result = mysqli_query($link, "INSERT INTO 1st_registration (username, cellphone, email, residential) VALUES ('".$_POST['username']."', '".$_POST['cellphone']."', '".$_POST['email']."', '".$_POST['residential']."')") or die("Could not update!");
...
<div class="login">
<h1>New Record:</h1>
<form method="POST" action="1tsrvc_chrch_reg.php" enctype="multipart/form-data"> 
      ...
      <a href="bookinghome.php" target="_blank" class="forgot">View Records</a>
