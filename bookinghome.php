<!DOCTYPE html> 
<html> 
<img align="right" src="logo2.jpg" alt="logo" height="50" width="100"/> 
<head> <meta charset="utf-8">
	<br><br>	
	<p align="center"><font color="red" face="Bodoni MT Black" size="12"><marquee behavior="alternate"> WELCOME TO AIC LUCKY SUMMER</marquee></font></p>
<title>Sevice Booking</title>
 <br>
 <font color="black">Click on either button to register for service of your choice</font>
<br><br>
 <div><a href="1tsrvc_chrch_reg.php" style="background-color: #228B22;
	...
	<br>
	<a href="2ndsrvc_chrch_reg.php" style="background-color: #000000;
	color: white;
	text-align: center;
	top: 0px;
	width: 100%
	...
	<h1 align="center">First Service</h1>
...
$link = mysqli_connect('localhost', 'root', '', 'employee');
 ...
 $query = "SELECT COUNT(*) AS count FROM 1st_registration";
 $query_result = mysqli_query($link, $query);
 while ($row = mysqli_fetch_assoc($query_result)) {
 	$output = '<b><font color = "#4B0082">Total Records:</b>'.$row['count'];
}
$absa =mysqli_query($link, "SELECT * from 1st_registration") or die('Could not connect!') ;
$sr = 1;
...
<head>
	<title>Sevice Booking</title>
	<h1 align="center">Second Service</h1>
</head>
<body>
		<table id="myTable">
		<thead>
